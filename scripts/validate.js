...
const setEventListeners = (form, inputList, buttonElement, inactiveButtonClass, inputErrorClass, errorClass) => {
...
const enableValidation = config => {
  ...
  formList.forEach(form => {
    ...
    setEventListeners(form, inputList, buttonElement, config.inactiveButtonClass, config.inputErrorClass, config.errorClass);
  });
};
